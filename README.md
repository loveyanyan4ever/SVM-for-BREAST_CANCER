...
使用支持向量机（SVM）完成乳腺肿瘤良恶性分类,数据集来自 `sklearn.datasets.load_breast_cancer`。
## 项目结构
...
```bash
git clone https://github.com/loveyanyan4ever/SVM-for-BREAST_CANCER.git
cd SVM-for-BREAST_CANCER
```
